...
$works = [
        [
        'nameWork' =>  'Системный администратор',
        'dateIn' => 'Март 2012',
        'dateOut' => 'Июнь 2015',
        'description' => 'Обслуживание и настройка ПК в офисе, установка ПО, контроль лицензий, обслуживание копировальной техники и т.д.',
        ],
        [
        'nameWork' =>  'Консультант',
        'dateIn' => 'Июль 2015',
        'dateOut' => 'Декабрь 2019',
        'description' => 'Разработка ТЗ, консультирование пользователей, постановка задач программистам.',       
        ],
        [
        'nameWork' =>  'Аналитик',
        'dateIn' => 'Январь 2020',
        'dateOut' => 'по настоящее время',
        'description' => 'Сбор и систематизация данных, организация сетевого хранилища, обслуживание БД, построение целевых моделей бизнес-процессов.',       
        ],
    ];
?>
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php for($j = 0; $j < count($works); $j++):
        ?>        
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $works[$j]['nameWork']; ?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $works[$j]['dateIn']; ?> - <?php echo $works[$j]['dateOut']; ?> <span class="w3-tag w3-teal w3-round">Current</span></h6>
          <p><?php echo $works[$j]['description']; ?></p>
          <hr>
        </div>
        <?php endfor; ?>
      </div>
